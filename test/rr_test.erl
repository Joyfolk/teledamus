...
empty_test() ->
	R = rr:from_app(test, round_robin),
...
add_test() ->
	set_env([r1, r2, r4]),
	RR = rr:from_app(test, round_robin),
	R = rr:add(RR, r3),
