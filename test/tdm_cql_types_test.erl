...
decode_test() ->
    ...
    ?assertEqual({[12, 13], <<>>}, tdm_cql_types:decode({list, bigint}, <<28:32, 2:32, 8:32,12:64, 8:32,13:64>>)),
...
helpers_test() ->
    ...
    ?assertEqual({{{list, int}, [1, 3, 5]}, <<3,2,1>>}, tdm_cql_types:decode_t({list, int}, <<28:32, 3:32, 4:32,1:32, 4:32,3:32, 4:32,5:32, 3,2,1>>)),

    ?assertEqual(2.5, tdm_cql_types:decode_v(float, <<4:32, 2.5:32/big-float,3,5>>)),
    ?assertEqual([1, 3, 5], tdm_cql_types:decode_v({list, int}, <<28:32, 3:32, 4:32,1:32, 4:32,3:32, 4:32,5:32, 3,2,1>>)),

    ?assertEqual({float, 2.5}, tdm_cql_types:decode_tv(float, <<4:32, 2.5:32/big-float,3,5>>)),
    ?assertEqual({{list, int}, [1, 3, 5]}, tdm_cql_types:decode_tv({list, int}, <<28:32, 3:32, 4:32,1:32, 4:32,3:32, 4:32,5:32, 3,2,1>>)),

    ?assertEqual(<<4:32, 2.5:32/big-float>>, tdm_cql_types:encode_t({float, 2.5})),
    ?assertEqual(<<28:32, 3:32, 4:32,1:32, 4:32,3:32, 4:32,5:32>>, tdm_cql_types:encode_t({{list, int}, [1, 3, 5]})),
